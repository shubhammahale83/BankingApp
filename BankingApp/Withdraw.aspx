<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Withdraw.aspx.cs" Inherits="BankingApp.Withdrawl" %>
    ...
    <table class="auto-style12">
        <tr>
            ...
            <td class="auto-style16">
                <asp:Label ID="lblWithdraw" runat="server" BackColor="#99CC00" BorderColor="#99CC00" BorderStyle="Inset" CssClass="auto-style18" Font-Bold="True" Font-Size="XX-Large" Text="Withdraw"></asp:Label>
            </td>
        ...
        <tr>
            ...
            <td class="auto-style19">
                <asp:Button ID="btnWithdraw" runat="server" BackColor="#FF3300" BorderColor="#FF3300" BorderStyle="Outset" CssClass="auto-style21" Font-Bold="True" Font-Overline="False" Font-Size="20px" ForeColor="White" Text="Submit" OnClick="btnWithdraw_Click" />
            </td>
            <td class="auto-style19">
